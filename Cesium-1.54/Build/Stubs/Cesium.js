...
define('DESource/DEVideoProjection', function() {
    return Cesium['DEVideoProjection'];
});
...
define('Shaders/ViewshedLineFS', function() {
    return Cesium['ViewshedLineFS'];
});

define('Shaders/ViewshedLineVS', function() {
    return Cesium['ViewshedLineVS'];
});
